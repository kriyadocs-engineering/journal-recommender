#!/usr/bin/env python3
"""
Scrape journal scope/aims from Scimago journal pages for American Society for Microbiology.
...
INPUT_CSV = DATA_DIR / "asm_journals.csv"
OUTPUT_JSON = DATA_DIR / "asm_journals_with_scope.json"
...
def main():
    print("=" * 60)
    print("American Society for Microbiology Journal Scope Scraper")
    print("=" * 60)

    # Parse CSV
    print("\n1. Parsing CSV...")
    journals = parse_csv()
    print(f"   Found {len(journals)} ASM journals")
